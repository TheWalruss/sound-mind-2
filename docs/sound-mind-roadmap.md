...
**Demo:** apply the new Space filter to a Filter layer and hear a sound extended through time, the way a physical room would; add speckle noise, then denoise it back out.
