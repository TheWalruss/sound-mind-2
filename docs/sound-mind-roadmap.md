...
**Demo:** open the Tool Configuration Wizard and build up a Clone tool step by step; paint with Order/Chaos pushed toward each extreme and hear the difference.
