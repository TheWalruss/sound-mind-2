...
**Demo:** lasso an irregular note shape the Rectangle tool couldn't isolate; wand-select a note plus its harmonics in one click; warp a selected region along a hand-drawn curve.
