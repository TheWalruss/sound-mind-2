...
public:
    ...
    ///        straight through. `sound_mind::core::BlendMode::Overwrite`
    ///        (the default) reproduces this method's own pre-`v0.Y.37.1`
    ...
    [[nodiscard]] std::optional<sound_mind::core::OperationId> pasteInto(
