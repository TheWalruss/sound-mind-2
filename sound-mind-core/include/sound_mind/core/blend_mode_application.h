 ...
 * - **`Overwrite`** is a hard, unconditional copy of `overlay` - `opacity`
 *   is ignored entirely, matching Paste/Mind Shot's own pre-`v0.Y.37.1`
 *   verbatim-copy behavior exactly.
 ...
 *        clamped here; ignored entirely for `BlendMode::Overwrite`.
